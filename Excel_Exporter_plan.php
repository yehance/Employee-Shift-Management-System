...
<?php require('include/topbar.php');    ?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h2 mb-2 text-gray-800">Shift Plan Excel Exporter</h1>
          ...
          <?php 
              ...
              <div class="alert alert-<?=$_SESSION['msg_type'] ?>">
               ...
               <meta http-equiv="refresh" content="1;url=http://localhost/SHIFT/Excel_Exporter_plan.php">
...
<div class="col-xl-12 col-md-6 mb-4">
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">Date Range Shift Plan Table Excel Exporter</h6>
    </div>
    <div class="card-body">
...
<div class="col-xl-12 col-md-6 mb-4">
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">Shift Plan Full Table Excel Exporter</h6>
    </div>
    <div class="card-body">
      <form method="post" action="export_all_plan.php">
        <div class="form-row">
